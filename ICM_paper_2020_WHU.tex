...
在我们的建模中，因为有且只有特定的星级会引起用户更多的评论，显然只有星级一个自变量，所以我们采用单变量方差分析\cite{stoline1981status}，我们的Model to relationship between specific star ratings and more reviews based on One-Way ANOVA 建立如下\\
\begin{enumerate}
	\item 我们先对数据进行筛选，选择每类产品最具代表性的样本:
	\begin{itemize}
