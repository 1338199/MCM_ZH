...
\subsubsection{time-based measures for reputation}
...
\subsection{reputation-time model on RBF regression}
...
\begin{enumerate}
	...
	\item 我们利用matlab搭建RBF网络：
	\begin{enumerate}
		\item 将样本的前一半作为训练集、后一半作为测试集，并作归一化处理
		\item 设定网络的神经元数逐步增加,最多就是训练样本个数，spread系数设定为0.1，开始训练
...
\begin{itemize}
	...
	\item 对于Pacifier信誉最低出现在xxxx年xx月xx号，Hair Dryer信誉最低出现在xxxx年xx月xx号，Microwave信誉最低出现在xxxx年xx月xx号，追踪临近的评论，我们发现可能是因为xxxx，导致其信誉下降，这启示阳光公司xxxx。
	\item 对于Pacifier信誉最高出现在xxxx年xx月xx号，Hair Dryer信誉最高出现在xxxx年xx月xx号，Microwave信誉最高出现在xxxx年xx月xx号，同样，我们追踪临近的评论，我们发现xxx可以使信誉提升，这启示阳光公司xxxx。
\end{itemize}
