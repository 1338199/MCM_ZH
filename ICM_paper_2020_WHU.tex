...
\begin{itemize}
	...
	\item \textbf{Comments on emotional tendencies are consistent with star ratings.}
...
Our statistical model also finds that some words in the comments are related to specific star ratings. For example, the comments with "disappointed" are closely related to the star rating of one star. For example the comments with "love" and "great" are closely related to the star rating of five stars. Therefore, we suggest that companies should focus on extracting comments with emotional words, research and analysis, and optimize products in a timely manner.
