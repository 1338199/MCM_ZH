...
\subsubsection{Relationship between specific star ratings and number of reviews}
特定的星级是否会引起更多的评论，对此我们可以判断这是一个统计学问题。可以使用单因素方差分析，以吹风机为例
\begin{itemize}
...
题目要求我们寻找出现在评论中的特定的词，如” disappointed”, ”enthusiasticer” ，是否会和评论的等级有关系。我们仍可以采用单因素方差分析，并结合曼彻斯特编码，以吹风机为例
\begin{itemize}
